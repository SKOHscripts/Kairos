...
Pas besoin de Python, de venv ni de terminal : les [releases GitHub](https://github.com/SKOHscripts/Kairos/releases) proposent un exécutable autonome par OS (`kairos-linux-x86_64`,
...
make test      # venv + suite de tests complète (j'essaye d'avoir 100%)
```
...
- **Créneaux occupés** : réunions saisies à la main, et calendrier personnel
  **TimeTree** (optionnel, voir Configuration). Chaque créneau manuel est **éditable**
  ...
  du jour ». Je vais regarder pour intégrer les agendas google par la suite.
