...
- L'après-midi (créneau creux configurable, défaut 13h-16h, tronc 15h), les
  tâches complexes cèdent la place à des tâches légères. L'effet est gradué et
  signalé (note « créneau creux (~15h) : tâche légère privilégiée ») ; le score
  WSJF affiché, lui, ne change pas.
